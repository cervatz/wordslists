...
<ul>	
	...
	<li><?=$form->input('administrator', array('label' => __('label_administrator', true), 'type'=>'checkbox', 'value'=>'', 'class' => 'required')); ?> </li> 	
	...
	echo('<li>');
	echo $form->input('mother_language_id0', array(  
	...
	<?php 
	echo('<li>');
	echo $form->input('practice_language_id0', array(  
