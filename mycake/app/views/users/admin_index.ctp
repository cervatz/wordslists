...
<table>
	...
	<tr>
		...
		<td><?php echo $html->link($html->image("icons/user.ico"), array('admin'=>true, 'controller'=>'users', 'action' => 'view', $user['User']['id']), array('escape' => false));?></td>		
		<td><?php echo $html->link($html->image("icons/edit.ico"), array('admin'=>true, 'controller'=>'users', 'action' => 'edit', $user['User']['id']), array('escape' => false));?></td>
		<td><?php echo $html->link($html->image("icons/deleteuser.ico"), array('admin'=>true, 'controller'=>'users', 'action' => 'delete', $user['User']['id']), array('escape' => false));?></td>
	</tr>
	<?php endforeach; ?>
